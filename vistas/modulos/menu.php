<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li><a href="clientes"><i class="fa fa-user-plus"></i><span>Clientes</span></a></li>

			<li><a href="categorias"><i class="fa fa-align-left"></i><span>Categorias</span></a></li>
			...
			<li class="treeview">
				...
				<a href="#"><i class="fa  fa-cart-plus"></i><span>Ventas</span>
					...
					<ul class="treeview-menu">
						...
						<li><a href="reportes"><i class="fa  fa-area-chart"></i><span>Reportes</span></a></li>
