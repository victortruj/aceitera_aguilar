<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      <i class="fa fa-pencil-square-o"></i> Editar venta
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-6" style="padding-right:0px">
                          ...
                          <div class="input-group">
                            ...
                            <span class="input-group-addon"><button type="button" class="btn btn-danger btn-xs quitarProducto" idProducto="'.$value["id"].'"><i class="fa fa-trash-o"></i></button></span>
